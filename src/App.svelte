<script>
  let name = "Keira"; // Change this to your name
  let favoriteNumber = 28; // Change this to your favorite number
  let bio = "I am a web developer with a passion for building cool things!";
  let hobbies = ["Coding", "Drawing", "Singing"]; // List some hobbies
